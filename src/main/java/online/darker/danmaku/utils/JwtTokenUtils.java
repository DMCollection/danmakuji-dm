package online.darker.danmaku.utils;

import io.jsonwebtoken.*;
import online.darker.danmaku.constant.SecurityConstants;
import online.darker.danmaku.enums.UserStatus;
...
public class JwtTokenUtils {
    ...
    public class Payload {
        ...
        private void init() {
            role = (String) claims.get(SecurityConstants.TOKEN_CLAIM_KEY_ROLE);
            int lock = (Integer) claims.get(SecurityConstants.TOKEN_CLAIM_KEY_LOCK);
            int email = (Integer) claims.get(SecurityConstants.TOKEN_CLAIM_KEY_EMAIL);
